...
class Explain(google.protobuf.message.Message):
    ...
    class ExprStep(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["id", b"id", "value_index", b"value_index"]) -> None: ...

    VALUES_FIELD_NUMBER: builtins.int
    EXPR_STEPS_FIELD_NUMBER: builtins.int
    @property
    def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[cel.expr.value_pb2.Value]:
    ...
    def __init__(
        self,
        *,
        values: collections.abc.Iterable[cel.expr.value_pb2.Value] | None = ...,
        expr_steps: collections.abc.Iterable[global___Explain.ExprStep] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["expr_steps", b"expr_steps", "values", b"values"]) -> None: ...
