...
class CheckedExpr(google.protobuf.message.Message):
    ...
    @property
    def source_info(self) -> cel.expr.syntax_pb2.SourceInfo:
        """The source info derived from input that generated the parsed `expr` and
        any optimizations made during the type-checking pass.
        """

    @property
    def expr(self) -> cel.expr.syntax_pb2.Expr:
    ...
    def __init__(
        ...
        *,
        ...
        source_info: cel.expr.syntax_pb2.SourceInfo | None = ...,
        expr_version: builtins.str = ...,
        expr: cel.expr.syntax_pb2.Expr | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["expr", b"expr", "source_info", b"source_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["expr", b"expr", "expr_version", b"expr_version", "reference_map", b"reference_map", "source_info", b"source_info", "type_map", b"type_map"]) -> None: ...
...
class Type(google.protobuf.message.Message):
    ...
    class _PrimitiveTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Type._PrimitiveType.ValueType], builtins.type):
    ...
    class _WellKnownTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Type._WellKnownType.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class ListType(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["elem_type", b"elem_type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["elem_type", b"elem_type"]) -> None: ...
    ...
    class FunctionType(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["result_type", b"result_type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["arg_types", b"arg_types", "result_type", b"result_type"]) -> None: ...
    ...
    class AbstractType(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["name", b"name", "parameter_types", b"parameter_types"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["abstract_type", b"abstract_type", "dyn", b"dyn", "error", b"error", "function", b"function", "list_type", b"list_type", "map_type", b"map_type", "message_type", b"message_type", "null", b"null", "primitive", b"primitive", "type", b"type", "type_kind", b"type_kind", "type_param", b"type_param", "well_known", b"well_known", "wrapper", b"wrapper"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["abstract_type", b"abstract_type", "dyn", b"dyn", "error", b"error", "function", b"function", "list_type", b"list_type", "map_type", b"map_type", "message_type", b"message_type", "null", b"null", "primitive", b"primitive", "type", b"type", "type_kind", b"type_kind", "type_param", b"type_param", "well_known", b"well_known", "wrapper", b"wrapper"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type_kind", b"type_kind"]) -> typing.Literal["dyn", "null", "primitive", "wrapper", "well_known", "list_type", "map_type", "function", "message_type", "type_param", "type", "error", "abstract_type"] | None: ...
...
class Decl(google.protobuf.message.Message):
    ...
    class IdentDecl(google.protobuf.message.Message):
        ...
        @property
        def value(self) -> cel.expr.syntax_pb2.Constant:
        ...
        def __init__(
            ...
            *,
            type: global___Type | None = ...,
            value: cel.expr.syntax_pb2.Constant | None = ...,
            doc: builtins.str = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["type", b"type", "value", b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["doc", b"doc", "type", b"type", "value", b"value"]) -> None: ...
    ...
    class FunctionDecl(google.protobuf.message.Message):
        ...
        class Overload(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["result_type", b"result_type"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["doc", b"doc", "is_instance_function", b"is_instance_function", "overload_id", b"overload_id", "params", b"params", "result_type", b"result_type", "type_params", b"type_params"]) -> None: ...
        ...
        def ClearField(self, field_name: typing.Literal["doc", b"doc", "overloads", b"overloads"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["decl_kind", b"decl_kind", "function", b"function", "ident", b"ident"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["decl_kind", b"decl_kind", "function", b"function", "ident", b"ident", "name", b"name"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["decl_kind", b"decl_kind"]) -> typing.Literal["ident", "function"] | None: ...
...
class Reference(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "overload_id", b"overload_id", "value", b"value"]) -> None: ...
