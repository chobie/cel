...
class Expr(google.protobuf.message.Message):
    ...
    class CreateList(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["elements", b"elements", "optional_indices", b"optional_indices"]) -> None: ...
    ...
    class Comprehension(google.protobuf.message.Message):
        ...
        *  `map` - apply an expression to all elements in the input and return the
        ...
        ITER_VAR2_FIELD_NUMBER: builtins.int
        ...
        def ClearField(self, field_name: typing.Literal["accu_init", b"accu_init", "accu_var", b"accu_var", "iter_range", b"iter_range", "iter_var", b"iter_var", "iter_var2", b"iter_var2", "loop_condition", b"loop_condition", "loop_step", b"loop_step", "result", b"result"]) -> None: ...
...
class SourceInfo(google.protobuf.message.Message):
    ...
    class Extension(google.protobuf.message.Message):
        ...
        class _ComponentEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[SourceInfo.Extension._Component.ValueType], builtins.type):
        ...
        def ClearField(self, field_name: typing.Literal["affected_components", b"affected_components", "id", b"id", "version", b"version"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["extensions", b"extensions", "line_offsets", b"line_offsets", "location", b"location", "macro_calls", b"macro_calls", "positions", b"positions", "syntax_version", b"syntax_version"]) -> None: ...
